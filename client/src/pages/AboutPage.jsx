const AboutPage = () => {
    return (
        <div className="about-page">
            ...
            <h2>Our Origin</h2>
            <p>I grew up in a small town in Florida. A place where the whispers of the wind carried 
            stories that I felt never truly represented who I was. As a member of the LGBTQIA+ 
            community, it was not until I discovered the warmth and acceptance of others like me that 
            I felt truly at home. However, finding these safe spaces was not always easy. That is why I 
            envisioned a platform where anyone, irrespective of where they come from, could find or 
            ...
            <p>But we are not just about places. We believe in building a strong, united community where 
            everyone has a voice that is heard. Every user submission, every photo, every review, every 
            comment builds upon our collective experience. It is our shared tapestry, woven with threads 
            ...
            come here. This is a safe space, please keep it as such.</p>
